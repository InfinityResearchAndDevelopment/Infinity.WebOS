    ...
    <div magic="` + magic + `" style="width:` + width + `;height:` + height + `;left:` + left + `;top:` + top + `;transform:scale(0);opacity:0" class="frame" min="true" max="0" visible="false"> \
    	...
    	<div class="unselectable titlebar"> \
    		...
    		<div class="titlebar-buttons"> \
    			...
    			<div class="titlebar-button frame-maximize-button"><i class="material-icons" style="font-size:0.8em;">crop_din</i></div> \
    			<div class="titlebar-button frame-restore-button"><i class="material-icons" style="font-size:0.8em;">filter_none</i></div> \
    			<div class="titlebar-button frame-close-button"><i class="material-icons" style="font-size:1em;">close</i></div> \
    		</div> \
    	</div> \
    </div>`;
